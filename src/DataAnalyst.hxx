...
public:
	...
	static double computeCompositionAt(DataManager const &dm, double x, double y, size_t step, double radius);
	static std::vector<double> computeCompositionEvolutionAt(DataManager const &dm, double x, double y, double radius);
